...
import pageObjects.supportPlatform.GmailPO;
...
public class BaseAction extends BasePage {
    ...
    public GmailPO openGmailSite() {
        goToGmailSite(driver);
        return AdminPageGeneratorManager.getGmailPage(driver);
    }
    ...
    public LoginPO switchToCmsPage(String cmsHandle) {
        switchToWindowByID(driver, cmsHandle);
        return AdminPageGeneratorManager.getAdminLoginPage(driver);
    }
