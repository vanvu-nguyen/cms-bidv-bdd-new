...
public class BasePage extends BaseTest {
    ...
    public void goToGmailSite(WebDriver driver) {
        driver.switchTo().newWindow(WindowType.TAB).get("https://mail.google.com/");
    }
    ...
    public void scrollToElement(WebDriver driver, String locator, String... restParams) {
        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", getElement(driver, locator), restParams);
    }
