...
public class GlobalConstants {
    ...
    private final String common_password = "infoCm$2024";
    ...
    // Admin invalid dev-env account
    private final String adminInvalidUsername = "admin@naver.co";
    private final String adminInvalidPassword = "12346";
